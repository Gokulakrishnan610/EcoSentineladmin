  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Tamil Nadu Citizen Reports</h1>
          <p className="text-muted-foreground">
            Monitor and manage incident reports from citizens across Tamil Nadu
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Badge className="bg-red-500 text-white">
            {mockReports.filter(r => r.severity === 'critical').length} Critical
          </Badge>
        </div>
      </div>
